  ...
  <div class="footer-container">
    ...
    <div class="footer-column brand-col">
      <a href="/" class="footer-logo">
        <svg width="80" height="80" viewBox="0 0 100 100" xmlns="http://ww<footer class="site-footer">
  <div class="footer-container">
...
<style>
  ...
  @media (max-width: 600px) {
    ...
    /* CENTERED LOGO AND TEXT FOR MOBILE */
    .brand-col {
      display: flex;
    ...
    .footer-logo {
      flex-direction: column; /* Stacks SVG and Text */
      justify-content: center;
      margin-bottom: 20px;
      gap: 10px;
    }
